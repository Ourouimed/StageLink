...
import { getProfile , updateProfile } from "@/store/features/encadrant/encadrantSlice";
...
export default function ProfileEncadrant() {
  const { profile, isLoading: isProfileLoading } = useSelector(state => state.encadrant);
