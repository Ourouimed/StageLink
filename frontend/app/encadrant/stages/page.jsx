                                ...
                                <tr key={s.stage_id} className="hover:bg-gray-50/80 transition-all">
                                    ...
                                    <td className="px-6 py-4 text-gray-600 text-sm">
                                        <span className="flex items-center gap-1">
                                                <span className="font-semibold text-gray-900">{(Number(s.note_evaluation) || 0).toFixed(2)}</span>
                                    ...
                                    <td className="px-6 py-4 text-gray-600 text-sm">
                                        <span className="flex items-center gap-1">
                                                <span className="font-semibold text-gray-900">{(Number(s.note_pedagogique) || 0).toFixed(2)}</span>
                                                <span className="text-xs text-gray-400">/ 20</span>
                                        </span>
                                    </td>
